...
| 浏览器 - 类型 | 访客访问活动时使用的浏览器类型。 | ChromeFirexInternet<br><br>Explorer10<br>SawareOther<br> |
| 浏览器-工作日/周末 | 访客访问活动时的工作状态(周末、工作时间或工作日免费时间)。 | 星期六和星期日是周末至<br>星期五，到星期五0900至1800年，<br>时间为1800至0900，直到0900为工作日免费时间 |
...
| 操作系统 | 访客用于访问活动的设备的操作系统。 | Mac OSWindows<br>10<br>LinuXSearch<br>BotTunknown<br>OS |
| 操作系统-版本 | 访客用于访问活动的操作系统版本。 | Windows10<br>Mac OS10 |
| 流量源-引用登陆页面URL | 访客访问您的站点时看到的第一页。 | `https://www.adobe.com/experience-cloud.html` |
...
| 网络-连接速度 | 访客访问活动时网络连接速度。 | BroadbandCabedSlMobileWiress卫星<br><br><br><br><br> |
...
| 属性名称 | 属性描述 | 示例值 |
| --- | --- | --- |
| 移动-设备-品牌 | 访客用来访问活动的移动设备品牌。 | Apple |
