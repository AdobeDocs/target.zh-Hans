...
|  | [开发人员指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank}中的&#x200B;*[!DNL Target]投放API概述* | 添加了关于通过[!DNL Recommendations]更新[!UICONTROL Catalogs] [!DNL Target Delivery API]时请务必谨慎的信息。 |
