...
1. 单击 **[!UICONTROL 删除]** 再次确认删除（已删除的预设无法恢复）。
...
为报表选择新的&#x200B;**[!UICONTROL 开始]**&#x200B;日期和&#x200B;**[!UICONTROL 结束]**&#x200B;日期。您还可以使用 **[!UICONTROL 从活动开始日期起]** 和 **[!UICONTROL 直到活动结束]** 复选框。
