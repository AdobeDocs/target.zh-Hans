...
description: 了解如何在 [!DNL Adobe Target] [!UICONTROL Experience Targeting]活动中指定量度以确定访问何时成功，例如[!UICONTROL Conversion]、[!UICONTROL Revenue]或[!UICONTROL Engagement]。
...
# 在[!UICONTROL Experience Targeting] (XT)活动中设置量度

在[!DNL Adobe Target] [!UICONTROL Experience Targeting] (XT)活动中使用量度来确定访问何时被视为成功。
