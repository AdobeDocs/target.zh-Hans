...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 2020 年 1 月 29 日 | [使用 Velocity 自定义设计](/help/c-recommendations/c-design-overview/customizing-a-template.md) | 更新了文本和代码范例。 新的代码范例显示了如何在Velocity模板中处理数字。 |
| 2020年1月28日 | [Target 发行说明（预发行版本）](/help/r-release-notes/target-release-notes.md) | 更改了目标标准版／高级版20.1.1版本的发布日期。 发布日期为2020年2月4日。 |
| 2020年1月27日 | [个性化分析报表](/help/c-reports/c-personalization-insights-reports/personalization-insights-reports.md) | 添加了新部分： “Adobe博客。” |
|  | [限制](/help/r-troubleshooting-target/target-limits.md) | 添加了以下信息： “如果您使用批处理投放API，则限制为每个批处理请求50个mbox。” |
...
|  | [实体属性](/help/c-recommendations/c-products/entity-attributes.md) | 添加了说明，说明如果您使用at.js 2。*x*, `mboxCreate` 不再受支持。 使用at.js 2将产品或内容信息传递给Recommendations。*x*，使用 `targetPageParams`。 |
...
| 2020年1月15日 | [在浏览器中启用混合内容](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/mixed-content.md) | 添加了培训视频和说明以说明如何更新站点设置以允许在最新版Chrome中使用混合内容。 |
|  | [信息源](/help/c-recommendations/c-products/feeds.md) | 添加了有关上传和删除实体和实体属性的注释。 |
|  | [“推荐”常见问题解答](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md) | 添加了以下常见问题解答： Recommendations内容跟踪中有时返回的NO_CONTENT响应表示什么？ |
|  | [创建订单确认 mbox - mbox.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/orderconfirm-create.md) | 添加了说明，说明如何使用at.js 2执行订单确认。*x* 目前不支持选择加入支持。 |
| 2020 年 1 月 9 日 | [TLS（传输层安全性）加密更改](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md) | 更新了文本。<br>2020年3月1日之后，Adobe目标将不再支持Visual Experience Composer(VEC)、Enhanced Experience Composer(EEC)、Adobe活动投放、API等的TLS 1.1加密。 请在2020年3月1日之前升级到TLS 1.2，以避免出现任何问题。 |
| 2020年1月6日 | [已知问题和已解决的问题](/help/r-release-notes/known-issues-resolved-issues.md) | 添加了有关自定义条件源状态的已知问题。 |
...
|  | [标准](/help/c-recommendations/c-algorithms/algorithms.md) | 添加了有关支持“标准使用”功能的注释。 |
...
|  | [目标内幕新闻快讯](/help/r-release-notes/target-insider-newsletter.md) | 添加了指向2019年11月新闻快讯的链接。 |
|  | [用户](/help/administrating-target/c-user-management/c-user-management/user-management.md) | 更新了“指定角色和权限”下的文本和图像。 |
| 2019 年 11 月 15 日 | [常见的A/B测试陷阱及其避免方法](/help/c-activities/t-test-ab/common-ab-testing-pitfalls.md) | 又补充了“4月7日： 在测试期间更改流量分配。” |
...
|  | [地域](/help/c-target/c-audiences/c-target-rules/geo.md#section_DD308A53AF0F48FA8C81423580561FE7) | 添加了说明不 [!DNL Target] 存储地理信息（如邮政编码）的信息。 |
| 2019 年 11 月 8 日 | [目标内幕新闻快讯](/help/r-release-notes/target-insider-newsletter.md) | 添加了指向其他过去问题的链接。 |
|  | [隐私和数据保护法规](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) | 更新了CCPA部分（带新注释）。<br>新增了常见问题解答，告知客户目标无法允许客户直接从目标共享或向第三方销售数据，因此不选择退出允许目标销售。 |
| 2019 年 11 月 7 日 | [配置文件属性](/help/c-target/c-visitor-profile/profile-parameters.md#examples) | 添加了adobeQA参数的代码示例。 |
| 2019 年 11 月 5 日 | [站点页面](/help/c-target/c-audiences/c-target-rules/site-pages.md#ts) | “疑难解答”部分中的更新文本。 |
...
|  | [从 at.js 1.x 升级到 at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#audience-parameters) | 添加了新部分： “哪个at.js 1.*at* .js 2中不支持创建受众的x参数。*x*?&quot; |
|  | [已知问题和已解决的问题](/help/r-release-notes/known-issues-resolved-issues.md) | 添加了有关向模板规则添加额外空间的新已知问题。 |
...
|  | [预览并启动您的推荐活动](/help/c-recommendations/t-create-recs-activity/previewing-and-launching-your-recommendations-activity.md) | 新主题。 |
| 2019 年 10 月 25 日 | [自定义参数](/help/c-target/c-audiences/c-target-rules/custom-parameters.md#considerations) | 在“注意事项”下添加了新项，以说明定位不会根据内部mbox参数进行评估。 |
|  | [使用动态和静态包含规则](/help/c-recommendations/c-algorithms/use-dynamic-and-static-inclusion-rules.md) | 完全更新主题并删除过时的示例。 |
...
| 2019 年 10 月 24 日 | [“推荐”常见问题解答](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md#section_DB3F40673AED42228E407C05437D99E9) | 以下常见问题解答中的更新文本： “为什么目标有时无法显示建议？” |
|  | [已知问题和已解决的问题](/help/r-release-notes/known-issues-resolved-issues.md#atjs) | 为影响at.js（版本2.2.0之前）早期版本的已知问题添加了注释。 |
|  | [成功量度](/help/c-activities/r-success-metrics/success-metrics.md) | 添加了有关使用A4T的活动成功量度的默认行为的注释。 |
| 2019 年 10 月 22 日 | [标准/算法](/help/c-recommendations/c-algorithms/algorithms.md#criteria-algorithms) | 为基于用户的推荐添加了行。 |
|  | [标准](/help/c-recommendations/c-algorithms/algorithms.md#custom-key) | 添加了新部分： “使用自定义推荐键。” |
|  | [目标和受众常见问题解答](/help/c-target/c-troubleshooting-targets-and-audiences/troubleshooting-targets-and-audiences.md) | 新增了常见问题解答： &quot;创建复杂的URL字符串时，是否 [!DNL Target] 对整个URL进行评估？&quot; |
...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 2019 年 10 月 17 日 | [活动 QA](/help/c-activities/c-activity-qa/activity-qa.md) | 更新了主题，以说明活动QA如何与第三方Cookies配合使用。 |
|  | [Target 发行说明（预发行版本）](/help/r-release-notes/target-release-notes.md) | 更新的发行说明，以包含有关对Unified Shell所做的更改的信息。 |
...
|  | [活动故障诊断](/help/c-activities/c-troubleshooting-activities/troubleshooting-activities.md) | 添加了新部分： “我使用活动UI创建了目标，无法通过API更新它。” |
...
| 2019 年 10 月 8 日 | [目标内幕新闻快讯](/help/r-release-notes/target-insider-newsletter.md) | 包含指向第一批新闻稿的链接的新主题，还有更多内容。 |
...
| 2019 年 9 月 10 日 | [Target 发行说明（当前版本）](/help/r-release-notes/release-notes.md) | 添加了有关目标标准版／高级版19.9.1版本的信息。 |
...
| 2019年9月6日 | [Target 发行说明（预发行版本）](/help/r-release-notes/target-release-notes.md) | 添加了有关目标标准版／高级版19.9.1（2019年9月10日）版本的信息。 |
...
|  | [设计常见问题解答](/help/c-recommendations/c-design-overview/template-faq.md) | 添加了以下常见问题解答：“推荐项目的价格并没有在小数点的右侧显示两个值。我该如何显示它们？” |
| 2019 年 8 月 16 日 | [mbox3rdPartyID 的实时配置文件同步](/help/c-target/c-visitor-profile/3rd-party-id.md) | 添加了新章节：“注意事项”。 |
