...
description: 了解如何使用Adobe中的“目标和设置”页面 [!DNL Target] 指定有关体验定位(XT)活动目标的信息。
...
![“活动设置”页面](/help/main/c-activities/t-experience-target/t-xt-create/assets/ab_settings-new.png)
...
如果未在“管理”中启用此选项（默认），请指定以下优先级：“低”、“中”或“高”。
...
指定是从 Adobe Target 还是从 Adobe Analytics 收集数据。请参阅[将 Adobe Analytics 作为 Target 报表源](/help/main/c-integrating-target-with-mac/a4t/a4t.md)，以了解各种报表解决方案之间的差异以及每种解决方案的优点。
