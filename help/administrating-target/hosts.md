...
## 主机 {#concept_516BB01EBFBD4449AB03940D31AEB66E}

可组织您的网站和预生产环境，以便轻松管理和分隔报表。

[!DNL Target Classic] 中提供有类似的功能。[!DNL Target Classic] 中的主机组在 [!DNL Target Standard/Premium] 中称为“环境”。
...
要按环境对“[!UICONTROL 主机]”列表进行筛选，请单击&zwnb;**[!UICONTROL 全部]下拉列表，然后选择所需的环境（“生产”、“测试”、“开发”或您创建的自定义环境）。**
...
1. 从[!UICONTROL 主机]列表中，单击&zwnb;**[!UICONTROL 环境]选项卡。**
...
1. 从[!UICONTROL 主机]列表中，单击&zwnb;**[!UICONTROL 设置]选项卡。**
1. 从&zwnb;**[!UICONTROL 环境设置]下拉列表中选择默认主机。**
1. 单击&zwnb;**[!UICONTROL 保存]**&zwnb;。
...
1. 从[!UICONTROL 主机]列表中，单击&zwnb;**[!UICONTROL 设置]选项卡。**
1. 选中&zwnb;**[!UICONTROL 为内容交付启用已授权的主机]复选框。**
1. 根据需要在&zwnb;**[!UICONTROL 主机包含]框中添加所需的主机。**
...
1. 从[!UICONTROL 主机]列表中，单击&zwnb;**[!UICONTROL 环境]选项卡。**
1. 将鼠标悬停在所需的环境上，然后单击&zwnb;**[!UICONTROL 编辑]图标。**
1. 更改环境名称。
1. 单击&zwnb;**[!UICONTROL 保存]**&zwnb;。
...
1. 单击&zwnb;**[!UICONTROL 删除]图标。**
1. 单击&zwnb;**[!UICONTROL 删除]以确认删除。**
