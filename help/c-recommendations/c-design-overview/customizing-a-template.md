...
description: 了解如何在Adobe [!DNL Target] Recommendations中使用开源Velocity设计语言自定义推荐设计。
...
在[!DNL Adobe Target Recommendations]中使用开源Velocity设计语言自定义推荐设计。
...
1. 在步骤1中创建的虚拟变量上，将实体属性传递到`parseInt`或`parseDouble`方法，以将字符串转换为整数或双值。
1. 对新数值执行数学运算或比较。
