...
**上次更新时间：2022 年 6 月 14 日（[查看更新内容](r-release-notes/doc-change.md)）**
...
- [适用于移动设备应用程序的 Target](https://developer.adobe.com/target/implement/mobile/)：说明 [!DNL Target] 如何用于移动设备应用程序优化和个性化。
