...
使用时，请参阅以下常见问题解答和答案 [!UICONTROL Automated Personalization] 活动：
...
### 我是否可以在Automated Personalization活动的中途更改目标量度？ {#change-metric}
...
使用 [!UICONTROL 重置报表数据] 选项 [!UICONTROL Automated Personalization] 不建议使用活动。 尽管会删除可见的报表数据，但此选项不会从 [!UICONTROL Automated Personalization] 模型。 而不是使用 [!UICONTROL 重置报表数据] 选项 [!UICONTROL Automated Personalization] 活动时，创建新活动并取消激活原始活动。 (注：本指南也适用于 [!UICONTROL 自动分配] 和 [!UICONTROL 自动定位] 活动。)
