...
>[!NOTE]
>
>此功能仅在[!UICONTROL 表]视图中查看报表时可用。 此功能不可用于使用 [Analytics 作为报表源 (A4T)](/help/main/c-integrating-target-with-mac/a4t/a4t.md#concept_7540C8C04259434AB6EE33B09F47A1DE) 的活动。

## 解释数据 {#section_62C0D7E76F3D49A7B3C371C82AEF27D5}

下图显示了[!UICONTROL 提升范围和置信度级别]信息：
...
* 对于[!UICONTROL 自动分配]活动，在某个体验达到60%的置信度之前，不显示提升度范围。
