...
* 如果您有at.js 1.*x*， [!UICONTROL 活动QA] 如果您使用Safari或其他阻止第三方Cookie的浏览器，则模式无粘性。 在这些情况下，您必须将预览参数添加到您导航到的每个URL中。 如果您已经实施，则情况也是如此 [CNAME](https://developer.adobe.com/target/before-implement/implement-cname-support-in-target/){target=_blank}.
