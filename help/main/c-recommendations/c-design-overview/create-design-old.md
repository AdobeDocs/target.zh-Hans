...
1. 在&#x200B;**[!UICONTROL 信息]**&#x200B;面板中，添加一个&#x200B;**[!UICONTROL 内容名称]**&#x200B;和一个可选的预览图像以显示在设计卡片上。
...
将鼠标悬停在[!UICONTROL 设计]库中的所需设计上，然后单击相应的图标：编辑、复制或删除。
...
1. 从设计库或基于表单的工作流中创建设计。 如果尝试在[!UICONTROL 可视化体验编辑器] (VEC)工作流中创建设计，则无法创建除了HTML设计之外的任何其他内容，该设计封装在`<div>`中以进行点击跟踪。
