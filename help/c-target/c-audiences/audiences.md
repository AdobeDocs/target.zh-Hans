...
seo-description: Adobe Target中的受众确定将在目标活动中查看内容和体验的用户。
seo-title: 在Adobe Target中创建受众
solution: Target
title: 创建受众
...
![“活动”&gt;“受众”定义](assets/audience_definition_list.png)
...
![“受众定义”卡上的使用选项卡](assets/audience_definition_mc.png)
