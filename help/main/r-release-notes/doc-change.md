...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 9 月 15 日 | [[!DNL Adobe Target] 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了有关以下网络研讨会的信息：<ul><li>优化AI支持的个性化：的新增功能 [!DNL Adobe Target] （2022年10月11日）</li></ul> |
| 9 月 13 日 | [了解  [!DNL Target]  UI](/help/main/c-intro/understand-the-target-ui.md) | 添加了有关 [!DNL Recommendations] 馈送失败。 |
