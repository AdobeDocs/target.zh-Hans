...
| 日期 | 主题 | 更改 |
|--- |--- |--- |
| 8 月 18 日 | [Target开发人员指南](https://experienceleague.adobe.com/zh-hans/docs/target-dev/developer/server-side/integration/a4t-reporting){target=_blank}中的&#x200B;*Analytics for Target (A4T)报告* | 更新了以下部分：<ul><li>更新了GET请求代码片段。</li><li>更新了查询字符串参数和变量表。</li><li>更新了&#x200B;*示例A4T数据插入HTTP Get调用*&#x200B;部分。</li></ul> |
