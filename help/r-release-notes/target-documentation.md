...
| [Adobe Target 开发人员](http://developers.adobetarget.com/) | 关于 Adobe Target 开发人员网站的信息帮助您在客户端应用程序、服务器端应用程序、移动应用程序、物联网等上实现 [!DNL Target]。还可将 [!DNL Target] 数据导出到第三方解决方案。 |
...
| [Target Adobe.IO 文档](http://developers.adobetarget.com/api/#introduction) | 关于 Adobe Target 的管理和配置文件 REST API 的文档，后者使用 Adobe.IO 集成管理活动、受众、选件、属性、报告、mbox、环境和配置文件。 |
