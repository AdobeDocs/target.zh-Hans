...
1. 设置&#x200B;**[!UICONTROL 回顾窗口]**&#x200B;以确定在确定要显示的推荐时所使用的可用历史用户行为数据的时间范围。 此选项适用于所有算法，但具有相似属性的项目和自定义算法除外。
...
>[!NOTE]
>
>如果您选择了&#x200B;**[!UICONTROL 基于项目的]**/**[!UICONTROL 具有相似属性的媒体]**&#x200B;作为您的算法类型和算法，则可以选择设置内容相似度规则。
