...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 2019 年 9 月 26 日 | [Feature flagging](/help/c-implementing-target/c-api-and-sdk-overview/feature-flagging.md) | 新主题。 |
...
| August 7, 2019 | [预取选件内容](/help/c-target-mobile-app/prefetch-offer-content.md) | 添加了注意，“自动目标”、“自动分配”和“自动个性化”活动类型不支持SDK中的预取功能。 |
...
| August 6, 2019 | [Target 发行说明（当前版本）](/help/r-release-notes/release-notes.md) | Added release notes for the Target Mobile VEC SDK iOS 2.1.0 &amp; Android 1.1.0 release. |
...
| August 1, 2019 | [Target发行说明（当前版本）](/help/r-release-notes/release-notes.md) | Added important announcement regarding API support for Enterprise Permissions. |
