...
| [自动定位](/help/main/c-activities/auto-target/auto-target-to-optimize.md)<br>![Target Premium](/help/main/assets/premium.png) | 自动定位使用高级机器学习找出从多种由营销人员定义的体验中找出表现好的体验。自动定位活动会根据每位访客的个别客户个人资料以及个人资料相似的以往访客的行为，为每位访客提供最适合的体验，以使内容个性化并促进转化。<br>**注意：**&#x200B;现在，您可以[在自动定位活动中包含推荐](/help/main/c-recommendations/recommendations-as-an-offer.md)。要使用此功能，您需要拥有 [Target Premium 许可证](/help/main/c-intro/intro.md#premium)。 |
