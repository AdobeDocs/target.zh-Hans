...
| [Target 推荐 API](https://experienceleague.adobe.com/docs/target-dev/developer/api/recommendations-api/overview.html){target=_blank} | 有关[!UICONTROL 推荐] API的信息，该API允许您以编程方式与[!DNL Target]推荐服务器交互。 这些 API 可与多种应用程序栈集成，以执行一般将通过 [!DNL Target] UI 执行的功能。 |
