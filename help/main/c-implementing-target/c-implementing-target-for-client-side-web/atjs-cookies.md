...
| Cookie 持续时间 | 自上次登录起，该Cookie将在访客的浏览器上保留两年。<br>的 `deviceIdLifetime` 中的设置可覆盖 [at.js版本2.3.1或更高版本](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/){target=_blank}。 有关更多信息，请参阅 [targetGlobalSettings()](https://developer.adobe.com/target/implement/client-side/atjs/atjs-functions/targetglobalsettings/){target=_blank}。 |
