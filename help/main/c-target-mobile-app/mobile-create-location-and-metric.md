...
description: 查看示例代码，以帮助您了解如何在iOS应用程序中创建位置和成功量度，以便能够使用Adobe [!DNL Target] 以个性化和优化您的应用程序。
...
>[!NOTE]
>
>请参阅 [移动设备文档](https://experienceleague.adobe.com/docs/mobile-services/ios/target-ios/c-target-methods.html) ，以了解所有可用Target方法的列表。
