...
受众是一组类似活动，将会看到有针对性的活动。一组具有相同特征的人员，例如新访客、回访访客或从中西部回访的访客。受众功能允许您将不同的内容和体验定位到特定受众，通过在恰当的时机向正确的人群展示正确的信息来优化您的数字营销。如果访客被识别为目标受众的一部分，则Target会根据在活动创建过程中定义的条件确定要显示的体验。
