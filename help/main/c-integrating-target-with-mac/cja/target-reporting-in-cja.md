...
>
>* 如果您选择[!UICONTROL Use a CJA Metric]作为活动的目标量度，则此选项可让您灵活地稍后定义成功量度。 由于在配置[!UICONTROL Experimentation]面板之前未选择[!DNL Customer Journey Analytics]成功量度，因此预建报表无法预先可用，因为[!DNL Customer Journey Analytics]不知道从哪个量度计算转化率和提升度。
