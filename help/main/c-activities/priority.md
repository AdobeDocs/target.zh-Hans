...
[!DNL Adobe Target]根据您使用的[!DNL Target]界面和活动创建功能([[!UICONTROL 可视化体验编辑器(VEC)]](/help/main/c-experiences/c-visual-experience-composer/visual-experience-composer.md)或[基于表单的体验编辑器](/help/main/c-experiences/form-experience-composer.md))，以不同的方式确定要交付给页面的活动（一个或多个）。

## 仅[!UICONTROL 可视化体验编辑器]或仅使用全局[!DNL Target]请求的[!UICONTROL 基于表单的体验编辑器] {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
1. [!DNL Target]次尝试将访客匹配到活动中。
   ...
   如果访客已经在[!UICONTROL A/B测试]或[!UICONTROL 多变量测试]活动中，则他们会匹配到该活动，直到发生转换。 如果他们以前处于[!UICONTROL 体验定位]活动中，则必须再次匹配该活动。 如果访客符合相应的受众规则，则他们将进入这些活动和特定的体验。
...
## [!UICONTROL 基于表单的体验编辑器]和[!UICONTROL 可视化体验编辑器] {#section_4620253E1CE942DD830724C7822B175F}

如果您的公司使用[!UICONTROL 基于表单的体验编辑器] *和* VEC，则来自多个[!UICONTROL 基于表单的体验编辑器]和VEC活动的内容可以交付。 以前，基于表单的工作流中只能交付一个活动。 可投放的基于表单的活动数量不再有限制。
...
1. [!DNL Target]次尝试将访客匹配到活动中。
   ...
   如果访客已经在[!UICONTROL A/B测试]或[!UICONTROL 多变量测试]活动中，则他们会匹配到该测试，直到发生转换。 如果他们以前处于[!UICONTROL 体验定位]活动中，则必须再次匹配该活动。 如果访客符合相应的受众规则，则他们将进入这些活动和特定的体验。
...
## 具有非全局[!DNL Target]请求的[!UICONTROL 基于表单的体验编辑器] {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}
...
>[!NOTE]
>
>根据您的设置，优先级值会有所不同。 您可以使用[!UICONTROL 低]、[!UICONTROL Medium]或[!UICONTROL 高]的旧设置，也可以启用0到999的细粒度优先级。 有关详细信息，请参阅[活动设置](/help/main/c-activities/activity-settings.md#task_C6B2FF8374724933BE79A83549B9CD02)。

响应：offer1

**两个活动只使用在[!UICONTROL 可视化体验编辑器]中为不同选择器创建的选件**
...
**两个活动只使用在[!UICONTROL 可视化体验编辑器]中为同一选择器创建的选件**
