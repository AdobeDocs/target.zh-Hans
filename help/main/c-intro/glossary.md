...
有关更多信息，请参见“报表常见问题”中的[如何计算“新访客”和“回访访客”指标？](/help/main/c-reports/reporting-frequently-asked-questions.md#methodology)。请与下方的“回访访客”进行对比。
...
报表提供了有关活动进度和结果的信息，可帮助您根据数据做出决策。报表数据可以帮助您确定何时结束测试，向您显示哪个体验或产品建议已入选，并提供确定后续操作所需的分析数据。
