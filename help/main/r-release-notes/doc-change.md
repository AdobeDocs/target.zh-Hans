...
| 日期 | 主题 | 更改 |
|--- |--- |--- |
| 9 月 19 日 | [目标指南中的](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}Adobe Target连接[!DNL Adobe Experience]。 | 更新了以下注释： *数据流在组织*&#x200B;中的唯一性。 |
