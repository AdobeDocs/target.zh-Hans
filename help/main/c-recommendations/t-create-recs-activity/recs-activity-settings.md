...
有关可用于描述和控制[!DNL Adobe Target]中的[!UICONTROL 推荐]活动的设置的信息。

以下部分介绍了[!UICONTROL 推荐]活动的可用设置。

## 名称

单击“更多操作”图标（ ![更多操作图标](/help/main/assets/icons/MoreSmallListVert.svg) ），然后单击&#x200B;**[!UICONTROL 重命名]**&#x200B;以提供描述性名称，帮助您和您的团队识别该活动。
