...
此信息可帮助您管理[!DNL Adobe Target]，包括Visual Experience Composer (VEC)、报表、Scene7配置、实现、主机、环境、URL、响应令牌、用户和[!DNL Recommendations]的配置设置。
...
* [列入允许列表的URL](/help/main/administrating-target/allowlisted-urls.md)
