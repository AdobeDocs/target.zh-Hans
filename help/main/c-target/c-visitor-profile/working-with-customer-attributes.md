...
有关使用[!DNL Adobe Experience Cloud People]服务中的客户属性将客户关系管理(CRM)数据库中的企业客户数据用于[!DNL Adobe Target]中的内容定位的信息。
...
* 在使用[!DNL People]服务中的[!UICONTROL Customer Attributes]功能之前，必须满足一些先决条件要求。 有关详细信息，请参阅&#x200B;*Experience Cloud界面和管理*&#x200B;指南中的[客户属性](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html#section_BD38693AFBF34926BA28E964963B4EA0)中的“上传客户属性的先决条件”。
