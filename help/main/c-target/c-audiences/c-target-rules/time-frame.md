...
1. 指定受众的[!UICONTROL 开始]和[!UICONTROL 结束]日期和时间。
...
1. （视情况而定）单击&#x200B;**[!UICONTROL 设置频率]**&#x200B;以设置循环模式，包括星期几和时间。
   ...
   例如，您可以使用[!UICONTROL Frequency]选项，仅在呼叫中心人员配备的日期和小时向访客显示“立即聊天”选项。

   选择一周中的一天或多天，然后设置开始时间和结束时间。 单击&#x200B;**[!UICONTROL 添加频率]**&#x200B;以根据需要指定其他模式。

   >[!NOTE]
   >
   >[!UICONTROL 将星期与日期分开]的时区显示为GMT +/- NN:NN，其中NN:NN是与GMT的时间差，它反映的是帐户级别时区，而不是访客所在时区。 例如，加利福尼亚的太平洋夏令时时时区将显示为GMT -07:00。
