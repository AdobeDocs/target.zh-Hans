...
有关预览URL如何与[!UICONTROL Automated Personalization](AP)活动一起运行的信息，请参阅[使用体验预览URL预览Automated Personalization活动](/help/c-activities/t-automated-personalization/experience-preview.md) 。
