...
**上次更新时间：2020年4月28日(请参[阅更改内容](r-release-notes/doc-change.md))**

>[!NOTE]
>
>随着mbox.js即将于2020年8月30日弃用，Adobe目标产品经理David Son将主持开发人员聊天，讨论将mbox.js迁移到at.js的好处。 有关详细信息，请参 [阅Adobe目标技能构建器：开发人员聊天，将Adobe目标的mbox.js迁移到at.js](/help/r-release-notes/release-notes.md#skill-builder)。
...
- [Adobe目标教程](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html):提供教程和视频，帮助您充分利用目标。
...
- [目标服务器端API](https://developers.adobetarget.com/api/delivery-api/):描述组成Adobe目标投放API的资源。
...
- [目标推荐API](https://developers.adobetarget.com/api/recommendations/):描述组成Adobe目标推荐API的资源。
- [目标Adobe.IO文档](http://developers.adobetarget.com/api/#introduction):介绍如何使用目标的Admin和用户档案REST API，这些API使用Adobe.IO集成来管理活动、受众、优惠、属性、报告、mbox、环境和用户档案。
