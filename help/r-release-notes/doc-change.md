...
| August 20, 2019 | [Target 发行说明（预发行版本）](/help/r-release-notes/target-release-notes.md) | 将Target/Premium 19.8.1版本推迟（2019年8月20日）。 Content from this release will be rolled into the 19.9.1 release (September 24, 2019). |
|  | [设计常见问题解答](/help/c-recommendations/c-design-overview/template-faq.md) | Added the following FAQ: "My recommended item's price isn't displaying both values to the right of the decimal point. How can I display them?" |
| 2019 年 8 月 16 日 | [mbox3rdPartyID 的实时配置文件同步](/help/c-target/c-visitor-profile/3rd-party-id.md) | Added new section: "Considerations." |
...
| 2019年8月12日 | [Android - 设置移动设备应用程序](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md#sdk-library) | Updated information about dependencies and artifacts.<br>Updated code sample for the `AndroidManifest.XML` file. |
...
| August 1, 2019 | [Target发行说明（当前版本）](/help/r-release-notes/release-notes.md) | 添加了关于企业权限的API支持的重要公告。 |
...
| 2019 年 7 月 29 日 | [报表常见问题解答](/help/c-reports/reporting-frequently-asked-questions.md) | Added new FAQ: "Why do my Experience Targeting (XT) reports contain metrics for control experiences?" |
