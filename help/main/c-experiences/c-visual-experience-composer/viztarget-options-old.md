...
添加在 [!DNL Adobe Journey Optimizer]](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started/starting-offer-decisioning.html){target=_blank}中创建的[选件，以使用Offer Decisioning向客户提供最佳选件和体验。
