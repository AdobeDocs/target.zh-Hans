...
description: 了解 [!DNL Target] 如何使用TLS（传输层安全性）协议来维护最高的安全标准并提升客户数据的安全性。
title: ' [!DNL Target] 如何使用TLS来提供安全性？'
feature: 隐私和安全
role: Developer
...
此信息介绍了对以下方面所做的更改：[!DNL Adobe]和[!DNL Adobe Target]如何使用TLS（传输层安全性）来维护最高安全标准并提升客户数据安全性。
...
有关支持的浏览器及其版本的更多详细信息，请参阅[支持的浏览器](/help/c-implementing-target/c-considerations-before-you-implement-target/supported-browsers.md#reference_01B4BF99E7D545A7998773202A2F6100)。
