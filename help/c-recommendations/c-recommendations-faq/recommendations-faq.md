...
>[!NOTE]
>
>当信息源文件的状态从“正在导入项目”变为“正在准备搜索索引更新”时，信息源文件会被视为已导入。更新可能需要60分钟以上的时间才能反映在目录搜索用户界面中；Catalog Search是动态消息状态更改为“已完成更新”时的最新状态。 即使目录搜索尚未更新，您的网站也会反映上述时间帧的更新。 最新的“目录搜索”索引更新时间将显示在“目录搜索”页面上。
