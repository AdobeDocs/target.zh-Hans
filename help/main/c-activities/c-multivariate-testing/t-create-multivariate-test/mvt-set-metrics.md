...
description: 了解如何在 [!DNL Adobe Target] [!UICONTROL 多变量测试]活动中指定量度以确定访问何时成功，例如[!UICONTROL 转化]、[!UICONTROL 收入]和[!UICONTROL 参与]。
title: 如何在[!UICONTROL 多变量测试] (MVT)活动中设置目标量度？
...
# 为[!UICONTROL 多变量测试]活动设置量度

在[!DNL Adobe Target] [!UICONTROL 多变量测试]中使用量度来确定访问何时被视为成功。
...
1. 选择[成功量度](/help/main/c-activities/r-success-metrics/success-metrics.md#reference_D011575C85DA48E989A244593D9B9924)
   ...
   [!UICONTROL 选择量度]页列出了可为活动选择的成功量度。 这些成功量度分为以下类别：
