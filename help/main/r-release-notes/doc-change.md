...
|  | [将 Target 边缘节点列入允许列表](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html?lang=zh-Hans){target=_blank} | 更新了重要说明。 |
...
|  | [targetGlobalSettings()](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/targetglobalsettings.html?lang=zh-Hans){target=_blank} | 更新的 `viewsEnabled` 描述。 |
|  | [单页应用程序实施](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/deploy-at-js/target-atjs-single-page-application.html?lang=zh-Hans){target=_blank} | 做出了以下更新：<ul><li>在“实施 Adobe Target 视图”下的第 2 步之后添加了注释。</li><li>更新了“初始页面加载的操作顺序”下的步骤 2“执行 Target 请求”。</li></ul> |
| 5 月 4 日 | [为 Adobe Target API 配置身份验证](https://experienceleague.adobe.com/docs/target-dev/developer/api/configure-authentication.html?lang=zh-Hans){target=_blank} | 添加了说明需要从 JWT 凭证迁移到 OAuth 服务器到服务器凭证的注释。 |
...
| 4 月 24 日 | [[!DNL Adobe Target] 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了关于接下来的 Adobe Target 社区茶歇问答的信息：<ul><li>针对经身份验证的环境的移动体验优化和个性化</li></ul> |
...
|  | [将 Target 边缘节点列入允许列表](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html?lang=zh-Hans){target=_blank} | 添加了注释以将所有 [!DNL Adobe Analytics] IP 地址块列入允许列表。 |
...
|  | [[!UICONTROL 自动分配]和[!UICONTROL 自动定位]活动支持 A4T](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md#supported) | 更新了“支持的目标量度”部分，以包含有关使用 [!UICONTROL Analytics for Target] (A4T) [!UICONTROL 自动分配]和[!UICONTROL 自动定位]活动的支持（和不支持）的量度的信息 |
|  | [Adobe Target 教程](https://experienceleague.adobe.com/docs/target-learn/tutorials/overview.html?lang=zh-Hans){target=_blank} | 更新了以下教程：<ul><li>[在  [!DNL Analysis Workspace]  中为[!UICONTROL 自动分配]活动设置 A4T 报表](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-allocate-activities.html?lang=zh-Hans){target=_blank}</li><li>[在  [!DNL Analysis Workspace]  中为[!UICONTROL 自动定位]活动设置 A4T 报表](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-target-activities.html?lang=zh-Hans){target=_blank}</li></ul> |
|  | [Target 发行说明（预发行版本）](/help/main/r-release-notes/target-release-notes.md) | 添加了 [!DNL Adobe Experience Manager] (AEM) 和 [!DNL Adobe Target] [!UICONTROL 内容片段]版本的信息。（2023 年 4 月 6 日） |
| 3 月 28 日 | [Target 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 添加了 [!DNL Target Standard/Premium] 23.3.1 版的发行说明。 |
...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 2 月 21 日 | [将 Target 边缘节点列入允许列表](https://experienceleague.corp.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html){target=_blank} | 更新了 IP 地址的列表以将 [Adobe Target 开发者指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/overview.html){target=_blank}中的所有地区均列入允许列表。 |
|  | [修改](/help/main/c-experiences/c-visual-experience-composer/c-vec-code-editor/vec-code-editor.md) | 添加了文字说明，使用 JQuery 的示例假设当 [!DNL Target] 执行优惠时，客户的网站在页面上有 JQuery 可用。 |
| 2 月 10 日 | [Target 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 添加了 [!DNL Target Standard/Premium] 22.14.5 版的发行说明。 |
...
|  | [Adobe Target 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了关于以下活动的信息：<ul><li>[!DNL Adobe Target] 社区问答喝咖啡休息时间：移动&amp;经验证的体验优化用例</li></ul> |
...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 1 月 13 日 | [可视化编辑帮助程序扩展](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md) | 添加了“常见问题解答”章节。 |
| 1 月 12 日 | [可视化体验编辑器助手扩展](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/vec-helper-browser-extension.md) | 更新了解释当前 [!UICONTROL Visual Experience Composer] 帮助程序扩展的状态的重要说明。 |
|  | [定位和受众常见问题解答](/help/main/c-target/c-troubleshooting-targets-and-audiences/troubleshooting-targets-and-audiences.md) | 添加了说明受众 URL 定位和通过[!UICONTROL 模板规则]添加的 URL 定位被评估为 URL 定位的信息。 |
|  | [Target 发行说明（预发行版本）](/help/main/r-release-notes/target-release-notes.md) | 添加了 22.13.3 版的预发行说明。 |
...
| 11 月 28 日 | [Adobe Target 开发人员指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/administration/models-api/models-api.html)中的{target=_blank}模型 API（阻止列表）概述&#x200B;**。 | 新的模型 API。<br>可以从 [!DNL Target] 机器学习算法中阻止功能，防止在任何[!UICONTROL 自动定位]或[!UICONTROL 自动个性化]模型或活动中使用它们。 |
...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 6 月 30 日 | [Adobe Target 开发人员指南](https://experienceleague.corp.adobe.com/docs/target-dev/developer/overview.html){target=_blank} | 发布了 *Adobe Target 开发人员指南*，将所有[!DNL Target]开发者内容整合到一个方便的门户中。该门户包含有关实施 [!DNL Target] 和 [!DNL Recommendations]、[!DNL Target] SDK 以及 [!DNL Target] API 的信息。 |
...
| 6 月 14 日 | [计划和实施 Recommendations](https://experienceleague.corp.adobe.com/docs/target-dev/developer/recommendations.html){target=_blank} | 更新了以下部分中的代码示例：<ul><li>购物车添加/购物车视图/结账页面</li><li>排除访客购物车中已有的项目</li></ul> |
...
|  | [at.js 版本详细信息](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank} | 添加了有关 at.js 2.9.0 版的信息。 |
|  | [用户代理和客户端提示](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/user-agent-and-client-hints.html){target=_blank}。 | 新主题。 |
...
|  | [内容安全策略 (CSP) 指令](https://experienceleague.corp.adobe.com/docs/target-dev/developer/implementation/privacy/content-security-policy.html){target=_blank}。 | 添加了常见问题解答部分。 |
...
| 4 月 13 日 | [Target 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了关于以下活动的信息：<ul><li>[!DNL Adobe Target] 社区问答喝咖啡休息时间（2022 年 4 月 27 日）</li></ul> |
...
|  | [Target 发行说明（预发行版本）](/help/main/r-release-notes/target-release-notes.md) | 添加了关于 [!DNL Target Standard/Premium] 22.3.1 版的预发行信息。 |
...
| 3 月 8 日 | [Target 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了关于以下活动的信息：<ul><li>[!DNL Adobe Target] 社区问答喝咖啡休息时间（2022 年 3 月 30 日）</li></ul> |
...
| 2 月 7 日 | [Target 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了关于以下活动的信息：<ul><li>[!DNL Adobe Target] 社区问答喝咖啡休息时间（2022 年 2 月 23 日）</li></ul> |
...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 1 月 31 日 | [Target 发行说明（预发行版本）](/help/main/r-release-notes/target-release-notes.md) | 添加了关于 [!DNL Target Standard/Premium] 22.2.1 版的预发行信息。 |
| 1 月 28 日 | [Target 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 添加了有关 at.js 2.8.1 版的信息。 |
|  | [at.js 版本详细信息](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank} | 添加了有关 at.js 2.8.1 版的信息。 |
...
| 1 月 21 日 | [at.js 版本详细信息](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank}。 | 添加了有关 at.js 1.8.3 版的信息。 |
| 1 月 19 日 | [从 at.js 1.*x* 升级到 at.js 2.x *x*](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank} | 添加了以下部分：“at.js 2.*x* 不支持使用 vst.* 参数创建受众” |
| 1 月 12 日 | [Target 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 添加了有关 [!DNL Target Standard/Premium] 22.1.1 版本的信息。 |
|  | [Adobe Experience Platform Web SDK](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/aep-web-sdk.html){target=_blank} | 添加了指向教程的链接，其中提供有关使用 Web SDK 实施 [!DNL Adobe Experience Cloud] 的说明。 |
