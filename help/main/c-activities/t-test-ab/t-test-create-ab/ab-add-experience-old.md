...
1. 在VEC的&#x200B;**[!UICONTROL 体验]**&#x200B;页面中，单击&#x200B;**[!UICONTROL 添加体验]**。
...
1. 单击[!UICONTROL A/B测试]或[!UICONTROL 体验定位] (XT)活动中某个体验的&#x200B;**[!UICONTROL 重命名体验]**&#x200B;图标，为体验提供一个新名称。
...
1. 单击[!UICONTROL A/B测试]或[!UICONTROL 体验定位] (XT)活动中某个体验的&#x200B;**[!UICONTROL 更多]**&#x200B;图标（垂直省略号），然后单击&#x200B;**[!UICONTROL 重定向到URL]**。
...
1. 在&#x200B;**[!UICONTROL 体验]**&#x200B;页面（三步引导式工作流的步骤1）中，单击垂直省略号图标> **[!UICONTROL 复制]**。
...
以下视频提供了有关使用[!UICONTROL 可视化体验编辑器]选项的信息。 (7:17)
