...
|  | [开发人员指南](https://experienceleague.adobe.com/zh-hans/docs/target-dev/developer/api/delivery-api/known-limitations){target=_blank}中的&#x200B;*[!DNL Target]注意事项和已知限制* | 添加了关于通过[!DNL Recommendations]更新[!UICONTROL Catalogs] [!DNL Target Delivery API]时请务必谨慎的信息。 |
