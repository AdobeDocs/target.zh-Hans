...
description: 了解如何创建在[!UICONTROL 基于表单的体验编辑器]中使用的JSON选件。
title: 如何创建JSON选件？
...
1. 单击&#x200B;**[!UICONTROL 创建选件]** > **[!UICONTROL JSON选件]**。
1. 键入产品建议名称。
...
您可以按JSON选件类型筛选[!UICONTROL 选件]库，方法是单击&#x200B;**[!UICONTROL 显示筛选器]**&#x200B;图标（![显示筛选器图标](/help/main/assets/icons/Filter.svg)），然后选中&#x200B;**[!UICONTROL JSON选件]**&#x200B;复选框。
