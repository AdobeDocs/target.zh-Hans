...
description: 了解如何在中创建受众 [!DNL Adobe Target] 基于网络详细信息。
...
您可以在中创建受众 [!DNL Adobe Target] 基于网络详细信息，如ISP、域名和连接速度。

1. 在 [!DNL Target] 界面中，单击&#x200B;**[!UICONTROL 受众]** > **[!UICONTROL 创建受众]**。
1. 为受众命名并添加可选描述。
1. 拖放 **[!UICONTROL 网络]** 放入受众生成器窗格。
1. 单击&#x200B;**[!UICONTROL 选择]**，然后选择以下选项之一：
   ...
   * **域名：** 此名称是访客IP地址的域名。 此名称不是您正在使用的网站的域名 [!DNL Target]. 此域名与访客的 IP 地址有关，有时也称为主机名。它类似于ISP名称。 有时，主机名会引用公司在变更其 ISP 名称之前使用的旧名称，而不引用域名。
