...
* 生成使用A4T和[!DNL Analytics]转换度量的[!UICONTROL 自动目标段]和[!UICONTROL 重要属性]活动的报告，其外观与使用[!DNL Target]作为报告源时相同。 ][!UICONTROL (TGT-38931)
...
* 将[!DNL Target] UI和API中优惠的大小限制提高到1 MB。 (TGT-38304)
