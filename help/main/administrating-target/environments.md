...
>
>如果在 [!DNL Adobe Experience Platform] 数据流[&#128279;](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html?lang=en#target){target=_blank}中指定了默认环境，则此设置将覆盖[!DNL Target]中的设置。
