...
>[!IMPORTANT]
>
>更新的[!UICONTROL 可视化编辑编辑器]需要[!DNL Chrome Web Store]中提供的[!DNL Adobe Experience Cloud] [[!UICONTROL 可视化编辑帮助程序]扩展](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md)。
...
与以前的版本一样，[!UICONTROL 体验]边栏保留在VEC的左侧。 无法折叠[!UICONTROL 体验]边栏。

![体验边栏](/help/main/c-experiences/c-visual-experience-composer/assets/experiences-panel.png)

您可以使用[!UICONTROL 体验]边栏创建、重命名或删除体验。 单击&#x200B;**[!UICONTROL 添加]**&#x200B;图标（![添加图标](/help/main/assets/icons/Add.svg)）以添加新体验。 单击[!UICONTROL 更多操作]图标（![更多操作图标](/help/main/assets/icons/MoreSmall.svg)）以复制、删除或重新定向体验。
...
要添加新组件，请从[!UICONTROL 组件]边栏中选择所需的组件，将鼠标悬停在页面中的现有元素上，然后选择在选定元素之前插入该组件。
...
要打开[!UICONTROL 修改]边栏，请单击[!UICONTROL 组件]边栏中的[!UICONTROL 显示修改]图标（![显示修改边栏](/help/main/assets/icons/History.svg)）。 [!UICONTROL 修改]边栏从编辑画布的右侧更改为左侧。
...
[!UICONTROL 修改]边栏显示对VEC中的页面所做的所有更改，并允许您进行其他更改（如CSS选择器、Mbox和自定义代码）。

单击[!UICONTROL 更多选项]图标（![更多操作图标](/help/main/assets/icons/MoreSmall.svg)）以添加修改、删除所有修改或删除所有无效修改。 单击[!UICONTROL 选择]以执行批量操作： [!UICONTROL 应用到所有页面]或[!UICONTROL 删除]。

要再次显示[!UICONTROL 修改]边栏，请单击[!UICONTROL 修改]边栏中的[!UICONTROL 隐藏修改]图标（![显示修改边栏](/help/main/assets/icons/History.svg)）。
...
[!UICONTROL 属性]边栏可在右边栏中折叠。 单击边栏右侧的[!UICONTROL 显示/隐藏属性]图标（![属性图标](/help/main/assets/icons/Propertie.svg)）以折叠或显示[!UICONTROL 属性]边栏。

### 活动设置/配置

单击设计画布顶部显示的[!UICONTROL 配置]图标（![配置图标](/help/main/assets/icons/Setting.svg)）以显示活动属性菜单。

![活动配置选项](/help/main/c-experiences/c-visual-experience-composer/assets/configure-options.png)

通过不同的选项，您可以分配属性、编辑页面交付规则、指定网站首选项、添加其他页面以及启用或禁用多页面或多个受众活动。 分配[!UICONTROL 属性]是[[!DNL Target Premium]](/help/main/c-intro/intro.md#premium)功能。

其位置和功能与以前的VEC UI类似。

### [!UICONTROL 设计]/[!UICONTROL 浏览]模式

使用[!UICONTROL 属性]边栏顶部显示的[!UICONTROL 设计]/[!UICONTROL 浏览]切换功能，可在设计和浏览模式之间切换。
...
[!UICONTROL 设计]画布允许您选择视区，包括适合屏幕大小、[!UICONTROL 桌面]、[!UICONTROL 平板电脑]、[!UICONTROL 移动设备横向]和[!UICONTROL 移动设备纵向]。
...
* [[!UICONTROL 可视化体验编辑器]更改](/help/main/c-experiences/c-visual-experience-composer/vec-changes.md)： [!DNL Adobe Target Standard/Premium] 25.2.1版本（2025年2月17日）引入了更新的[!UICONTROL 可视化体验编辑器] (VEC)。 本文介绍VEC旧版本与更新版本之间的差异。
