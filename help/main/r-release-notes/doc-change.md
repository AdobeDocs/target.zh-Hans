...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 6 月 24 日 | [Adobe Target开发人员指南门户](https://developer-stage.adobe.com/target/){target=_blank} | 启动了 *Adobe Target开发人员指南* 整合所有 [!DNL Target] 在一个方便的门户中提供开发人员内容。 该门户包含有关实施的信息 [!DNL Target] 和 [!DNL Recommendations], [!DNL Target] SDK和 [!DNL Target] API。 |
...
|  | [at.js版本详细信息](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/){target=_blank} | 添加了有关 at.js 2.9.0 版的信息。 |
