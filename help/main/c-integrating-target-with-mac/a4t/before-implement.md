...
>[!NOTE]
>
>本文仅适用于at.js实施。 有关使用[!DNL Adobe Experience Platform Web SDK]实现[!UICONTROL Analytics for Target] (A4T)的信息，请参阅Experience Platform Web SDK[&#128279;](https://experienceleague.adobe.com/docs/target-dev/developer/a4t/overview-a4t.html){target=_blank}中的Adobe Analytics for Target (A4T)日志记录。
