...
有关详细信息，请参阅&#x200B;*Analytics管理员指南*&#x200B;中的[转化变量(eVar](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/conversion-variables/conversion-var-admin.html))。
