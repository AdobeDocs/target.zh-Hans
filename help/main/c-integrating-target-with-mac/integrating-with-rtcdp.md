...
| 解决方案 | 用例已启用 |
| --- | --- |
| <ul><li>[!DNL RTCDP]（任何 SKU）和 [!DNL Target]</li></ul> | <ul><li>下一个会话个性化<ul><li>对于带有 [!UICONTROL at.js] 的所有页面</li></ul></li><li>同一页面个性化<ul><li>对于带有 [!DNL Platform Web SDK] 的所有页面</li></ul></li></ul> |
