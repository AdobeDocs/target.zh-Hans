...
1. 选择要更改的元素，然后进行所需的更改。
   ...
   在[创建[!UICONTROL 体验定位]活动](/help/main/c-activities/t-experience-target/t-xt-create/xt-create.md)时，三步引导式工作流（[!UICONTROL 体验]）中的第一步会显示具有[!UICONTROL 所有访客]受众的默认[!UICONTROL 体验A]。

   ![“所有访客”受众](/help/main/c-activities/t-experience-target/t-xt-create/assets/all-visitors-new.png)

   您现在所做的任何更改均适用于[!UICONTROL 体验A]。在下面的步骤中，单击&#x200B;**[!UICONTROL 添加体验定位]**&#x200B;以创建其他体验。
...
1. 若要创建其他体验，请单击“添加”****（![“添加”按钮](/help/main/assets/icons/Add.svg)）。
   ...
   创建受众时，您可以选择位置并指定该位置的参数。 在[!UICONTROL 自定义] （[!UICONTROL 创建受众] > [!UICONTROL 自定义]）下，选择位置，然后指定所需的参数。

   >[!NOTE]
   >
   >打开受众列表时，系统会自动在后台导入受众，导入的受众为10分钟之前的受众。

1. 选择一个或多个要使用体验定位的受众，然后单击&#x200B;**[!UICONTROL 分配受众]**。
...
1. （视情况而定）在创建或编辑[!UICONTROL 体验定位]活动时，拖放受众和体验对以按所需顺序排列受众和体验对。

   单击“重新排序”图标（![重新排序图标](/help/main/assets/icons/Reorder.svg)）以在右侧显示[!UICONTROL 体验]列，然后根据需要重新排列体验。

   将按从上到下的顺序评估访客的体验。

   [!UICONTROL 体验定位]假定顺序重要。 如果访客属于第一个受众和体验对，则交付第一个体验。

   例如，假设您在创建[!UICONTROL 体验定位]活动时不知道顺序很重要。 您稍后在测试期间意识到，您认为应该符合体验B或C的访客实际上符合体验A的资格。这种情况可能是因为受众并非相互排斥，并且顺序不正确（例如，体验A =美国，体验B =旧金山，体验C =加利福尼亚）。 在此情景中，所有来自美国的用户都有资格使用体验A，即使他们位于旧金山或加利福尼亚的其他地方也是如此。 您可以重新排序受众和体验对，从限制最严格到限制最少（旧金山>加利福尼亚>美国），而无需重新创建整个活动。

   如果您有[!UICONTROL 所有访客]受众，请确保它不是图中的第一个受众。 定位到“[!UICONTROL 所有访客]”的体验可以用作[!UICONTROL 体验定位]活动中的最后一个体验，以“捕获”所有还未进入任何其他体验的访客。

## 重命名、编辑、复制或删除体验

单击[!UICONTROL 体验定位]活动图中的某个体验，可在右侧显示[!UICONTROL 体验]列。

![“重命名”和“编辑”选项](/help/main/c-activities/t-experience-target/t-xt-create/assets/experience_edit-refresh.png)

根据需要，从以下选项中进行选择：

* **[!UICONTROL 重命名]**：在[!UICONTROL 名称]字段中键入所需的名称。
* **[!UICONTROL 编辑]**：单击“编辑”图标（![编辑图标](/help/main/assets/icons/Edit.svg)），然后进行所需的更改。
* **[!UICONTROL 复制]**：复制[!UICONTROL 体验定位]活动中的体验，以便您可以对其进行细微更改，而无需重新创建整个体验。 单击[!UICONTROL 复制]图标（![复制图标](/help/main/assets/icons/Duplicate.svg)），然后根据需要编辑体验。
* **[!UICONTROL 删除]**：单击[!UICONTROL 删除]图标（![删除图标](/help/main/assets/icons/Delete.svg)），然后确认删除操作。
...
本视频介绍如何使用[!UICONTROL 体验定位] (XT)将A/B测试提升到新的水平。

* 描述用于配置[!UICONTROL 体验定位]活动的三步引导式工作流
...
以下视频介绍了 [!DNL Target] 中可用的活动类型。 从5:15开始讨论[!UICONTROL 体验定位]。
...
本视频提供有关使用[!UICONTROL 体验定位] (VEC)选项的信息。
