...
>[!NOTE]
>
>本文仅适用于at.js实施。 有关使用[!DNL Adobe Experience Platform Web SDK]实施[!UICONTROL Analytics for Target] (A4T)的信息，请参阅Experience Platform Web SDK[&#128279;](https://experienceleague.adobe.com/docs/target-dev/developer/a4t/overview-a4t.html?lang=zh-Hans){target=_blank}中的Adobe Analytics for Target (A4T)日志记录。
...
在填写[Marketing Cloud集成设置表单](https://survey.adobe.com/jfe/form/SV_ekBHTLSoP5Zki2y){target=_blank}时，请注意以下有关“[!UICONTROL 您请求设置]”下的哪些功能[!UICONTROL 共享受众]选项的重要信息。

![申请表单](/help/main/c-integrating-target-with-mac/a4t/assets/request-form.png)

当您请求[!UICONTROL 共享受众]时，您启用了[!UICONTROL Target]和[!UICONTROL Adobe Audience Manager] (AAM)来共享信息，在本例中是共享受众。
