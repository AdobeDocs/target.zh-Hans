...
description: 了解如何使用Adobe [!DNL Target] 中的受众过滤器来视图共享特定特征或特征集的访客组的数据。
...
* **访客可以属于多个受众。** 如果设置了两个受众(例如，“新访客”和“来自Google的访客”)，且某人符合这两个条件，则会在这两个受众中计算和跟踪此访客。因此，受众中的访客总和并不等于活动中的访客数。
