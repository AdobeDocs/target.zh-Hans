...
**上次更新时间：2020 年 7 月 31 日（[请参阅“更改了哪些内容”](r-release-notes/doc-change.md)）**

>[!NOTE]
>
>**Adobe再次被评为Gartner个性化引擎魔力象限的领导者**
>
...
- [Adobe TargetTutorials](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html): 提供教程和视频，帮助您充分利用目标。
...
- [目标RecommendationsAPI](https://developers.adobetarget.com/api/recommendations/): 描述组成正式Adobe TargetRecommendationsAPI的资源。
