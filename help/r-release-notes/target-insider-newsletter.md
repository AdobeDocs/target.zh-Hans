...
| [2019年11月（第2卷，第11期）](https://expleague.azureedge.net/assets/target/2019_11_Target_Newsletter_Nov_2019.html) | 我们有令你兴奋的消息！ 首先，Forrester在《Forrester Wave:数字智能平台，2019年第4季度。 我们刚刚发布了新的开源Node.js SDK和我们功能强大的基于用户的新Recommendations算法。 我们还获得了由一位Adobe Target从业者分享的有关个性化和优化的绝佳提示。 接着，社交媒体影响者Goldie Chan在最近两次LinkedIn Live会议中采访了Adobe Target的杰森·希基和我。 Adobe的Jamie Brighton就管理数据和将数据隐私作为竞争优势的工具发表了看法。 最后，移动应用程序开发人员可以参加最终的移动应用程序技能构建器。 |
| [2019 年 10 月（第 2 卷，第 10 期）](https://expleague.azureedge.net/assets/target/2019_10_Target_Newsletter_Oct_2019.html) | 在本期刊中，我们为您提供大量精彩内容。 从在线新闻出版商McClatchy的Wendy Melemed那里获取个性化和优化提示。 注册并参加即将为移动应用程序开发人员举办的免费技能构建器虚拟实验室。 发现将Adobe Target与Adobe Campaign整合的巨大优势。 并下载体验个性化的制胜剧本，它是一个用于构建强大的个性化项目的逐行指南。 最后，我们向您介绍Experience League的Adobe Target资源，了解这些资源可以帮助您快速使用行业领先的个性化解决方案。 |
| 2019年9月 | 本月未发布新闻稿。 |
