...
若要开始，请使用[!UICONTROL 可视化体验编辑器]创建一个[!UICONTROL A/B测试]或[!UICONTROL 体验定位]活动，并使用[!UICONTROL 推荐]操作向体验添加推荐。
...
1. 创建[体验](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md)时，单击要将推荐作为选件添加到的元素，单击&#x200B;**[!UICONTROL 替换内容]** （![替换内容图标](/help/main/assets/icons/Switch.svg)），然后选择&#x200B;**[!UICONTROL 推荐]**。

   ![将推荐作为产品建议插入](/help/main/c-recommendations/t-create-recs-activity/assets/recs-as-offer.png)

1. 从右侧的[!UICONTROL 推荐]边栏中，单击&#x200B;**[!UICONTROL 选择推荐]**&#x200B;以显示[!UICONTROL 选择标准]对话框。

1. 单击&#x200B;**[!UICONTROL 创建标准]**&#x200B;或选择现有标准。

1. （可选）单击&#x200B;**[!UICONTROL 筛选器]**&#x200B;图标（![筛选器图标](/help/main/assets/icons/Filter.svg)）从以下选项中进行选择，以查看按页面类型划分的热门推荐标准：
...
1. 单击&#x200B;**[!UICONTROL 创建标准]**&#x200B;或选择现有的[标准](/help/main/c-recommendations/c-algorithms/algorithms.md)，然后单击&#x200B;**[!UICONTROL 下一步]**&#x200B;以显示[!UICONTROL 选择设计]对话框。

1. 单击&#x200B;**[!UICONTROL 创建设计]**&#x200B;或选择现有的[设计](/help/main/c-recommendations/c-design-overview/design-overview.md)，然后单击&#x200B;**[!UICONTROL 下一步]**。
...
1. 从[!UICONTROL 推荐]边栏中，单击[!UICONTROL 标准名称]、[!UICONTROL 设计名称]或[!UICONTROL 收藏集名称]旁边的&#x200B;**[!UICONTROL 编辑]**&#x200B;图标（![编辑图标](/help/main/assets/icons/Edit.svg)）以更改元素。

## 删除推荐产品建议

1. 单击[!UICONTROL 推荐]面板顶部的&#x200B;**[!UICONTROL 删除]**&#x200B;图标（![删除图标](/help/main/assets/icons/Delete.svg)）。

### 查看推荐选件的状态 {#status}

推荐选件（算法）状态显示在包含推荐选件的A/B测试和XT活动的活动[!UICONTROL 概述]页面的底部：
