...
description: 了解为什么某些网站可能无法在[!UICONTROL 可视化体验编辑器] (VEC)中以可靠的方式打开。 [!UICONTROL 可视化编辑帮助程序]浏览器扩展允许您在VEC中以可靠的方式加载网站。
...
## 对[!UICONTROL 可视化编辑帮助程序]扩展的更改（2026年1月17日）
...
针对的[!DNL Adobe Experience Cloud] [!UICONTROL 可视化编辑帮助程序]浏览器扩展解决了客户现在依赖于[!DNL Target] [增强型体验编辑器](/help/main/administrating-target/visual-experience-composer-set-up.md#eec)或第三方扩展（如Requestly）的站点加载问题。

## 使用[!UICONTROL 可视化编辑帮助程序]扩展的好处
...
1. 若要使用该扩展，请在VEC或QA模式下单击Chrome浏览器工具栏中的[!UICONTROL 可视化编辑帮助程序]浏览器扩展图标（![可视化编辑扩展图标](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/assets/visual-editing-helper.png)）。
   ...
   在[!UICONTROL Target] VEC中打开网站以进行创作时，[!UICONTROL 可视化编辑帮助程序]会自动启用。 该扩展不具有任何有条件的设置。 该扩展会自动处理所有设置，包括 SameSite cookie 设置。
...
* 对于[!DNL Target]，该扩展加载最新版本的at.js，该版本可从[!UICONTROL 管理] > [!UICONTROL 实现]中的[!DNL Target] UI访问，并且at.js会下载创作库。
