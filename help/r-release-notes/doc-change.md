...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 2020年2月18日 | [发行说明](/help/r-release-notes/release-notes.md) | 添加了有关mbox.js库即将弃用的信息。 |
|  | [地域](/help/c-target/c-audiences/c-target-rules/geo.md) | 添加了注意，mboxOverride.browserIp仅在at.js 1中受支持。*x* 目前不支持选择加入支持。 |
