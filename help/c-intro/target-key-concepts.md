---
keywords: 概述和参考;行为
description: 学习Adobe Target的基础知识。 这是了解目标、活动类型和其他功能的好地方。
title: 如何使用目标?
feature: Overview
...
| 共享受众 | 可以在 [!DNL Adobe Experience Cloud] 解决方案之间共享受众。有关示例，请参见[受众](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html)。 |
...
### 在Adobe Target使用受众(6:21)![概述徽章](/help/assets/overview.png)
