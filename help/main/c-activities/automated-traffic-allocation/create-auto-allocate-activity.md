...
description: 了解如何使用 [!UICONTROL 可视化体验编辑器] (VEC)位于 [!DNL Adobe Target] 创建 [!UICONTROL 自动分配] A/B测试活动。
...
使用 [!UICONTROL 可视化体验编辑器] (VEC)位于 [!DNL Adobe Target] 创建您的 [!UICONTROL 自动分配] [!UICONTROL A/B测试] 活动直接在 [!DNL Target]启用页面，并在中修改页面的各个部分 [!DNL Target].

除了 [!UICONTROL 自动分配] [!UICONTROL A/B测试] 活动（将在本文中讨论）， [!DNL Target] 提供了两种附加类型 [!UICONTROL A/B测试] 活动： [!UICONTROL 手动（默认）] 和 [!UICONTROL 自动定位]. 请参阅 [A/B测试活动的类型](/help/main/c-activities/t-test-ab/test-ab.md#types) 在 *A/B测试概述*.
...
1. 在 **[!UICONTROL 创建A/B测试活动]** 对话框，选择 **[!UICONTROL 可视化]**（如有必要）。
...
1. 指定[活动 URL](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-activity-url.md)，然后单击&#x200B;**[!UICONTROL 创建]**。
