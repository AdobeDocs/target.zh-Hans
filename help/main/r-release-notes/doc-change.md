...
| 日期 | 主题 | 更改 |
| --- | --- | --- |
| 6 月 3 日 | [优先级](/help/main/c-activities/priority.md) | 更新了整个主题，包括指示来自多个主题的内容 [!UICONTROL Form-Based Experience Composer] 和VEC活动可以交付的内容。 以前，基于表单的工作流中只能交付一个活动。 可投放的基于表单的活动数量不再有限制。 |
| 5 月 17 日 | [对与相关的问题进行故障诊断 [!UICONTROL Enhanced Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md) | 添加了可在使用时允许列表的其他IP地址 [!UICONTROL Enhanced Experience Composer]. |
...
| 4 月 9 日 | [对与相关的问题进行故障诊断 [!UICONTROL Visual Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-visual-experience-composer-vec.md) | 更新了以下部分：<ul><li>VEC 中不显示我的页面（仅 VEC）</li></ul>添加了以下新章节：<ul><li>中的CSS冲突导致的问题 [!UICONTROL Visual Experience Composer]</li></ul> |
...
|  | [Target 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 更新了整个部分：“更新 `Browser:iPad` 和 `Browser:iPhone` 在 [!UICONTROL Browser] 受众属性（2024年4月30日）”。 |
...
| 2 月 26 日 | [[!DNL Adobe Target] 公告和活动](/help/main/r-release-notes/target-announcements.md) | 添加了关于即将推出的产品的信息 [!UICONTROL Adobe Target Community] 茶歇（2024年2月28日）。 |
...
| 2 月 5 日 | [创建使用 Analytics 作为报告源的活动](/help/main/c-integrating-target-with-mac/a4t/campaign-creation.md) | 添加了文本，指定在使用时，不能对来自不同工作区的两个活动使用相同的活动名称 [!UICONTROL Analytics for Target] (A4T)作为报表源。 |
|  | [活动设置 - A4T 常见问题解答](/help/main/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-activity-setup.md) | 添加了文本，指定在使用时，不能对来自不同工作区的两个活动使用相同的活动名称 [!UICONTROL Analytics for Target] (A4T)作为报表源。 |
...
| 1 月 22 日 | [Target 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 添加了有关弃用iPad和iPhone的重要信息，请参阅 [!UICONTROL Browser] 需要您在2024年4月30日之前进行更改的受众属性。 |
...
| 11 月 29 日 | [批量配置文件更新 API](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/methods/bulk-profile-update-api.html){target=_blank} | 阐明了以下方面的差异： [!DNL Target] 为用户创建配置文件时处理客户属性 [!DNL Target] 在使用时尚未看到 [!UICONTROL Bulk Profile Update API] v2而非v1。 |
...
| 11 月 17 日 | [管理员首要步骤](/help/main/administrating-target/start-target.md) | 添加了以下重要注释：<ul><li>用户具有 [!UICONTROL Product Admin] 或 [!UICONTROL System Admin] 中的权限 [!DNL Adobe Admin Console] 可以编辑或更改 [!UICONTROL Administration] 第页，共页 [!DNL Target]，不考虑他们的 [!DNL Target] 角色。 用户没有 [!UICONTROL Product Admin] 或 [!UICONTROL System Admin] 中的权限 [!DNL Adobe Admin Console] 必须具有特定的 [!DNL Target] 进行这些更改的角色。1</li></ul> |
...
| 10 月 25 日 | [[!DNL Target] 发行说明（当前版本）](/help/main/r-release-notes/release-notes.md) | 添加了关于 [!UICONTROL Activities] 页面用户界面刷新（2023年10月25日） |
...
|  | [在中设置A4T报表 [!DNL Analysis Workspace] 对象 [!UICONTROL Auto-Allocate] 活动](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-allocate-activities.html){target=_blank} | 在中更新了整个教程 *[!UICONTROL Adobe Target Tutorials]* 指南。 |
...
| 9 月 22 日 | [对与相关的问题进行故障诊断 [!UICONTROL Enhanced Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md#section_D29E96911D5C401889B5EACE267F13CF) | 将 IP 地址列表更新为了允许列表。 |
...
|  | [选件](/help/main/c-experiences/c-manage-content/manage-content.md) | 添加了注释来说明图像选件不属于 [!UICONTROL Enterprise User Permissions] 模型。 |
