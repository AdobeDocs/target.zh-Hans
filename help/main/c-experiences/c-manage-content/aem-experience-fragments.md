...
description: 了解如何在 [!DNL Adobe Target] 活动中使用 [!DNL Adobe Experience Manager] 体验片段。
...
在[!DNL Target]活动中使用在[!DNL Adobe Experience Manager] (AEM)中创建的体验片段(XF)和内容片段(CF)以帮助优化或个性化。
