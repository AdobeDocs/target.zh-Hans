...
| September 9, 2019 | [AEM 体验片段](/help/c-experiences/c-manage-content/aem-experience-fragments.md#considerations) | 添加了“注意事项”部分。 |
...
| September 6, 2019 | [Target 发行说明（预发行版本）](/help/r-release-notes/target-release-notes.md) | 添加了有关Target Standard/Premium 19.9.1（2019年9月10日）版本的信息。 |
|  | [Target for mobile apps FAQ](/help/c-target-mobile-app/target-for-mobile-apps-faq.md) | 新主题。 |
...
| 2019 年 8 月 23 日 | [Target 移动设备预览](/help/c-target-mobile-app/target-mobile-preview.md) | 更新了中的代码片断 `AndroidManifest.xml`。 |
...
|  | [自定义参数](/help/c-target/c-audiences/c-target-rules/custom-parameters.md#considerations) | Added new section: "Considerations." |
|  | [上传自定义标准](/help/c-recommendations/c-algorithms/recommendations-csv.md) | 更新了以下句子：自定义条件更新默认为“累积”。 CSV 上传文件中指定的新键值对会覆盖现有的键值对。没有在CSV上传中指定密钥的现有密钥值对仍可交付，并将在作为CSV文件的一部分上次上传它们的31天后过期。 |
| 2019年8月20日 | [Target 发行说明（预发行版本）](/help/r-release-notes/target-release-notes.md) | 将Target/Premium 19.8.1版本推迟（2019年8月20日）。 此版本中的内容将转入19.9.1版本（2019年9月24日）。 |
...
|  | [Target 发行说明（当前版本）](/help/r-release-notes/release-notes.md) | Updated the list of enhancements and fixes in the "Target Mobile VEC SDK iOS 2.1.0 &amp; Android 1.1.1" section. |
|  | [编辑活动或另存为草稿](/help/c-activities/edit-activity.md#classic) | Added new section: "Work with legacy activities created in Recommendations Classic." |
| 2019 年 8 月 9 日 | [at.js 的工作原理](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md#render) | Added new section: "How at.js renders offers with HTML content." |
|  | [可视化体验编辑器选项](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#considerations) | 添加了新部分：“考虑事项。” |
| 2019年8月7日 | [预取选件内容](/help/c-target-mobile-app/prefetch-offer-content.md) | Added note that the prefetch functionality in the SDKs is not supported for Auto Target, Auto Allocate, and Automated Personalization activity types. |
|  | [Analytics 与 Target 集成 (A4T) 故障诊断](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/a4t-troubleshooting.md#unspecified) | Updated note indicating how long the classification process takes to complete. |
|  | [查看报表 - A4T 常见问题解答](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md#unspecified) | Updated note indicating how long the classification process takes to complete. |
...
| 2019年8月6日 | [Target 发行说明（当前版本）](/help/r-release-notes/release-notes.md) | Added release notes for the Target Mobile VEC SDK iOS 2.1.0 &amp; Android 1.1.0 release. |
...
| 2019年8月1日 | [Target发行说明（当前版本）](/help/r-release-notes/release-notes.md) | Added important announcement regarding API support for Enterprise Permissions. |
...
|  | [创建条件](/help/c-recommendations/c-algorithms/create-new-algorithm.md#recently-viewed) | Added note to Recently Viewed Items. |
...
|  | [移动设备应用程序可视化体验编辑器](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#ts) | 更新了“疑难解答”部分，以反映字符限制不再适用于应用程序名称。 这些限制仅适用于ID。 |
