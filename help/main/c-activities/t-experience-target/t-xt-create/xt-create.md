---
keywords: 体验定位；XT；创建
description: 了解如何在Adobe中使用可视化体验编辑器(VEC) [!DNL Target] ，以在启用了Target的页面上创建体验定位(XT)活动。
title: 如何创建体验定位活动？
...
有关体验定位、用例情景和培训视频的更多信息，请参阅[体验定位](/help/main/c-activities/t-experience-target/experience-target.md)。
...
1. 如有必要，选择&#x200B;**[!UICONTROL 可视（默认）]**。
   ...
   ![“创建体验定位活动”对话框](/help/main/c-activities/t-experience-target/t-xt-create/assets/form_url-new.png)
...
1. 指定[活动 URL](/help/main/c-activities/t-experience-target/t-xt-create/xt-activity-url.md#concept_D28549AAA0A14E3BB5F05F32BE8ABC90)，然后单击&#x200B;**[!UICONTROL 下一步]**。
