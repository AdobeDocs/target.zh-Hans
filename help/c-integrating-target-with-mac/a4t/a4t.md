...
所有[!DNL Analytics]量度（包括计算量度）均在[!DNL Target]和[!DNL Analytics]中的[!UICONTROL 目标活动]报表中可用。 同样，[!DNL Analytics]中可用的任何区段都可以应用于这两个解决方案。 您可以在活动启动后，甚至在活动完成后，将量度或受众应用到[!DNL Target]中的报表。
...
下表显示哪些活动类型支持[!DNL Analytics]作为[!DNL Target](A4T)中的报告源：
...
| Node.JS | 是 | 有关详细信息，请参阅&#x200B;*Adobe Target SDK*&#x200B;指南中的[Node.js SDK](https://adobetarget-sdks.gitbook.io/docs/sdk-reference-guides/nodejs-sdk)。 |
...
## A4T报告{#section_F0A43A1CB2F04E8282B909E4D7034361}示例
