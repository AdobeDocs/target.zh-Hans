...
| [!UICONTROL 发布者] | 与 [!UICONTROL 观察者] 角色（可以查看活动，但不能创建或编辑活动）。 但是，[!UICONTROL 发布者]角色另有激活活动的权限。 |
...
如果用户拥有多个角色和权限，则应用具有层级权限的角色。 例如，如果用户具有 [!UICONTROL 观察者] 和 [!UICONTROL 审批者] 角色， [!UICONTROL 审批者] 角色已应用。
