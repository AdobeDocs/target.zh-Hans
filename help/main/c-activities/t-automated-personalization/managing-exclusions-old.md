...
1. 根据需要排除相应的体验。
   ...
   或者，您也可以批量排除体验，方法是选中相关体验的复选框，然后单击对话框右上角的&#x200B;**[!UICONTROL 排除]**&#x200B;图标。 选中一个或多个体验时，将显示[!UICONTROL 排除]图标。
...
1. 在[创建或编辑AP活动](/help/main/c-activities/t-automated-personalization/create-ap-activity.md)时，选择要替换的内容并单击以访问&#x200B;**[!UICONTROL 更改文本/HTML]**、**[!UICONTROL 更改图像]**&#x200B;或&#x200B;**[!UICONTROL 更改背景颜色]**。
1. 在出现的对话框中，创建新的内容，然后取消选中默认内容右侧的&#x200B;**包含**（或在[!UICONTROL 选择内容]屏幕中取消选中“默认图像/视频”）。

   根据内容或选件类型，[!UICONTROL 包含]复选框的位置略有不同。
...
1. 单击&#x200B;**[!UICONTROL 保存]**。
   ...
   您可以在“[!UICONTROL 管理内容]”下方看到使用指定的选件创建的体验。 您注意到，在[!UICONTROL 管理内容]中，没有使用您排除的默认选件创建任何体验。

   ![exclude_content_vec_4图像](assets/exclude_content_vec_4.png)

**要使用基于表单的体验编辑器[!UICONTROL 排除默认内容]：**

1. 创建或编辑 AP 活动时，在&#x200B;**[!UICONTROL 内容]**&#x200B;下方单击&#x200B;**[!UICONTROL 更改文本/HTML]** 或&#x200B;**[!UICONTROL 更改图像选件]**。
1. 在出现的对话框中，创建新的内容，然后取消选中默认内容右侧的&#x200B;**[!UICONTROL 包含]**（或在[!UICONTROL 选择内容]屏幕中取消选中“默认图像/视频”）。
