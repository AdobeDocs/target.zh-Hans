...
>[!NOTE]
>
>根据您的设置，优先级值会有所不同。您可以使用“低”、“中”或“高”的传统优先级设置，也可以启用 0 至 999 的细粒度优先级设置。有关详细信息，请参阅 [活动设置](../c-activities/activity-settings.md#task_C6B2FF8374724933BE79A83549B9CD02)。
