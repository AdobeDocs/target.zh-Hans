...
的 [!UICONTROL 修改] 页面上会显示在可视化体验编辑器(VEC)中对页面所做的所有更改，以及通过单击页面上的每个元素所做的其他更改，以及 [选择操作](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#reference_3BD1BEEAFA584A749ED2D08F14732E81). 您所做的每个更改都会在“[!UICONTROL 修改]”列表中单独显示为一个操作或元素。您还可以添加修改，其中包括以下修改类型：CSS 选择器、Mbox 和自定义代码。
...
以下使用JQuery的示例假定客户网站在 [!DNL Target] 执行选件。
