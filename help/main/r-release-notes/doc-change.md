...
| 1 月 19 日 | [从 at.js 1.*x* 升级到 at.js 2.*x*](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/) | 添加了以下部分：“at.js 2.*x* 不支持使用 vst.* 参数创建受众” |
